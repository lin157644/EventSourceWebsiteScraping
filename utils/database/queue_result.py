...
from utils.load_env import MONGO_HOST_PAGE, MONGO_USER, MONGO_PASSWORD, MONGO_PORT_PAGE, DATABASE_PAGE, QUEUE_COLLECTION

MONGO_DETAILS = f"mongodb://{MONGO_USER}:{MONGO_PASSWORD}@{MONGO_HOST_PAGE}:{MONGO_PORT_PAGE}"

client = MongoClient(MONGO_DETAILS)

database = client[DATABASE_PAGE]

page_collection = database.get_collection(QUEUE_COLLECTION)
